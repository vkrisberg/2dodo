...
export default {
  ...
  registration: ({name, password, email, open_key, hash_key, device_id, device_name, platform, settings, push_token}) => {
    const http = services.getHttp();
    const data = {name, password, email, open_key, hash_key, device_id, device_name, platform, settings, push_token};
